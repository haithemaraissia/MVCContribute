...
namespace MVC.Controls
{
    public static class Manager
    {
        ...
        /// <returns></returns>
        public static MvcHtmlString AsAutoComplete(this MvcHtmlString html, AutoComplete autoComplete)
        {
            string elemId = getIdFromString(html);
            return new MvcHtmlString(html.ToHtmlString() + autoComplete.Render(elemId));
        }
